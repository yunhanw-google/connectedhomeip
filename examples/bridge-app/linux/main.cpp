...
chip::DataVersion bridgedLightClustersVersion[4] = { 0 };
DECLARE_DYNAMIC_CLUSTER_LIST_BEGIN(bridgedLightClusters)
DECLARE_DYNAMIC_CLUSTER(ZCL_ON_OFF_CLUSTER_ID, onOffAttrs, &bridgedLightClustersVersion[0]),
    DECLARE_DYNAMIC_CLUSTER(ZCL_DESCRIPTOR_CLUSTER_ID, descriptorAttrs, &bridgedLightClustersVersion[1]),
    DECLARE_DYNAMIC_CLUSTER(ZCL_BRIDGED_DEVICE_BASIC_CLUSTER_ID, bridgedDeviceBasicAttrs, &bridgedLightClustersVersion[2]),
    DECLARE_DYNAMIC_CLUSTER(ZCL_FIXED_LABEL_CLUSTER_ID, fixedLabelAttrs,
                            &bridgedLightClustersVersion[3]) DECLARE_DYNAMIC_CLUSTER_LIST_END;
...
chip::DataVersion bridgedSwitchClustersVersion[4] = { 0 };
DECLARE_DYNAMIC_CLUSTER_LIST_BEGIN(bridgedSwitchClusters)
DECLARE_DYNAMIC_CLUSTER(ZCL_SWITCH_CLUSTER_ID, switchAttrs, &bridgedSwitchClustersVersion[0]),
    DECLARE_DYNAMIC_CLUSTER(ZCL_DESCRIPTOR_CLUSTER_ID, switchDescriptorAttrs, &bridgedSwitchClustersVersion[1]),
    DECLARE_DYNAMIC_CLUSTER(ZCL_BRIDGED_DEVICE_BASIC_CLUSTER_ID, switchBridgedDeviceBasicAttrs, &bridgedSwitchClustersVersion[2]),
    DECLARE_DYNAMIC_CLUSTER(ZCL_FIXED_LABEL_CLUSTER_ID, switchFixedLabelAttrs,
                            &bridgedSwitchClustersVersion[3]) DECLARE_DYNAMIC_CLUSTER_LIST_END;
