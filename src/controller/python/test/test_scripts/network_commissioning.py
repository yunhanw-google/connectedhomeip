...
class NetworkCommissioningTests:
    ...
    async def test_wifi(self, endpointId):
        ...
        res = await self._devCtrl.SendCommand(nodeid=self._nodeid, endpoint=endpointId, payload=req, responseType=None, timedRequestTimeoutMs=None, interactionTimeoutMs=20000)
