...
CHIP_ERROR SubscribeResponseMessage::Parser::CheckSchemaValidity() const
{
    ...
    while (CHIP_NO_ERROR == (err = reader.Next()))
    {
        ...
        case to_underlying(Tag::kMinIntervalFloorSeconds):
            VerifyOrReturnError(!(tagPresenceMask & (1 << to_underlying(Tag::kMinIntervalFloorSeconds))), CHIP_ERROR_INVALID_TLV_TAG);
        ...
        case to_underlying(Tag::kMaxIntervalCeilingSeconds):
            VerifyOrReturnError(!(tagPresenceMask & (1 << to_underlying(Tag::kMaxIntervalCeilingSeconds))), CHIP_ERROR_INVALID_TLV_TAG);
        ...
        case to_underlying(Tag::kInteractionModelRevision):
            ReturnErrorOnFailure(CheckInteractionModelRevision(tagPresenceMask, to_underlying(Tag::kInteractionModelRevision), reader));
            break;
        default:
    ...
    if (CHIP_END_OF_TLV == err)
    {
        const uint16_t RequiredFields =
            (1 << to_underlying(Tag::kSubscriptionId)) | (1 << to_underlying(Tag::kMinIntervalFloorSeconds)) | (1 << to_underlying(Tag::kMaxIntervalCeilingSeconds)) | (1 << to_underlying(Tag::kInteractionModelRevision));
...
CHIP_ERROR SubscribeResponseMessage::Parser::GetInteractionModelRevision(InteractionModelRevision * const apInteractionModelRevision) const
{
