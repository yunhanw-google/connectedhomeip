...
CHIP_ERROR InvokeResponseMessage::Parser::CheckSchemaValidity() const
{
    ...
    {
        const int RequiredFields = (1 << to_underlying(Tag::kSuppressResponse)) | (1 << to_underlying(Tag::kInvokeResponses))| (1 << to_underlying(Tag::kInteractionModelRevision));
...
CHIP_ERROR InvokeResponseMessage::Parser::GetInteractionModelRevision(InteractionModelRevision * const apInteractionModelRevision) const
{
