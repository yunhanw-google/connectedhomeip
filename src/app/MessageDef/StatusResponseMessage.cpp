...
CHIP_ERROR StatusResponseMessage::Parser::CheckSchemaValidity() const
{
    ...
    {
        const int requiredFields = (1 << to_underlying(Tag::kStatus)) | (1 << to_underlying(Tag::kInteractionModelRevision));
...
CHIP_ERROR StatusResponseMessage::Parser::GetInteractionModelRevision(InteractionModelRevision * const apInteractionModelRevision) const
{
