...
CHIP_ERROR WriteResponseMessage::Parser::CheckSchemaValidity() const
{
    ...
    {
        const int RequiredFields = (1 << to_underlying(Tag::kWriteResponses)) | (1 << to_underlying(Tag::kInteractionModelRevision));
...
CHIP_ERROR WriteResponseMessage::Parser::GetInteractionModelRevision(InteractionModelRevision * const apInteractionModelRevision) const
{
