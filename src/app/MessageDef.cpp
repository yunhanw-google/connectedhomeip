...
CHIP_ERROR AttributePath::Parser::GetNodeId(uint64_t * const apNodeId) const
{
    return GetUnsignedInteger(kCsTag_NodeId, apNodeId);
}

CHIP_ERROR AttributePath::Parser::GetEndpointId(uint16_t * const apEndpointId) const
{
...
AttributePath::Builder & AttributePath::Builder::EndpointId(const uint16_t aEndpointId)
{
    // skip if error has already been set
    SuccessOrExit(mError);
...
CHIP_ERROR EventPath::Parser::GetNodeId(uint64_t * const apNodeId) const
{
    return GetUnsignedInteger(kCsTag_NodeId, apNodeId);
}

CHIP_ERROR EventPath::Parser::GetEndpointId(uint16_t * const apEndpointID) const
{
    return GetUnsignedInteger(kCsTag_EndpointId, apEndpointID);
}
...
EventPath::Builder & EventPath::Builder::EndpointId(const uint16_t aEndpointId)
{
    // skip if error has already been set
    SuccessOrExit(mError);
...
// 3) all elements have expected data type
// 4) any tag can only appear once
CHIP_ERROR CommandPath::Parser::CheckSchemaValidity(void) const
{
    CHIP_ERROR err           = CHIP_NO_ERROR;
    uint16_t TagPresenceMask = 0;
    chip::TLV::TLVReader reader;
...
CHIP_ERROR CommandPath::Parser::GetEndpointId(uint16_t * const apEndpointID) const
{
    return GetUnsignedInteger(kCsTag_EndpointId, apEndpointID);
}

CHIP_ERROR CommandPath::Parser::GetGroupId(uint32_t * const apGroupId) const
{
    return GetUnsignedInteger(kCsTag_GroupId, apGroupId);
}

CHIP_ERROR CommandPath::Parser::GetClusterId(uint32_t * const apClusterId) const
{
    return GetUnsignedInteger(kCsTag_ClusterId, apClusterId);
}

CHIP_ERROR CommandPath::Parser::GetCommandId(uint16_t * const apCommandId) const
{
...
CommandPath::Builder & CommandPath::Builder::EndpointId(const uint16_t aEndpointId)
{
    // skip if error has already been set
    SuccessOrExit(mError);
...
CommandPath::Builder & CommandPath::Builder::GroupId(const uint32_t aGroupId)
{
    // skip if error has already been set
    SuccessOrExit(mError);
...
CommandPath::Builder & CommandPath::Builder::ClusterId(const uint32_t aClusterId)
{
    // skip if error has already been set
    SuccessOrExit(mError);
...
CommandPath::Builder & CommandPath::Builder::EndOfCommandPath(void)
{
    EndOfContainer();
    return *this;
}
...
CHIP_ERROR CommandDataElement::Parser::GetCommandPath(CommandPath::Parser * const apCommandPath) const
{
    ...
    err = LookForElementWithTag(mReader, chip::TLV::ContextTag(kCsTag_CommandPath), &reader);
    SuccessOrExit(err);
...
CommandDataElement::Builder & CommandDataElement::Builder::EndOfCommandDataElement(void)
{
    EndOfContainer();
...
// 2) all elements are anonymous and of Structure type
// 3) every Data Element is also valid in schemasd
CHIP_ERROR CommandList::Parser::CheckSchemaValidity(void) const
{
    CHIP_ERROR err        = CHIP_NO_ERROR;
...
// Mark the end of this array and recover the type for outer container
CommandList::Builder & CommandList::Builder::EndOfCommandList(void)
{
    EndOfContainer();
    return *this;
}
...
// 3) any tag can only appear once
// At the top level of the message, unknown tags are ignored for foward compatibility
CHIP_ERROR InvokeCommandRequest::Parser::CheckSchemaValidity(void) const
{
    CHIP_ERROR err           = CHIP_NO_ERROR;
    uint16_t TagPresenceMask = 0;
    chip::TLV::TLVReader reader;
...
InvokeCommandRequest::Builder & InvokeCommandRequest::Builder::EndOfInvokeCommandRequest(void)
{
    EndOfContainer();
    return *this;
}
