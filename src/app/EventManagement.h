...
constexpr const uint32_t kFabricIndexEventNumberTag         = 0x2;
...
public:
    ...
    void Init(uint32_t aNumBuffers, CircularEventBuffer * apCircularEventBuffer,
              const LogStorageResources * const apLogStorageResources, MonotonicallyIncreasingCounter * apEventNumberCounter, FabricTable * apFabricTable);
...
private:
    ...
    struct EventEnvelopeContext
    {
        ...
        uint32_t mFabricIndexEventNumber = 0;
    };
