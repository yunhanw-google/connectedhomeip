...
public:
    ...
    public:
         ...
         */
        virtual void OnAttributeData(const ReadClient * apReadClient, DataVersion *apVersion, const ConcreteDataAttributePath & aPath,
    ...
    void SendSubscribeRequest(ReadPrepareParams && aReadPrepareParams);
