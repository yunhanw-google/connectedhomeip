                                           ...
                                           const EventOptions * apOptions)
{
    ...
    {
        apContext->mWriter.Put(TLV::ProfileTag(kEventManagementProfile, kFabricIndexTag),
                               apOptions->mFabricIndex.Value());
    }
...
{
    ChipLogError(EventLogging, "current fabric index is %u", eventLoadOutContext->mFabricIndex);;
