...
namespace BarrierControlCluster {
constexpr ClusterId kClusterId = 0x0103;
...
namespace ColorControlCluster {
constexpr ClusterId kClusterId = 0x0300;
...
namespace EthernetNetworkDiagnosticsCluster {
constexpr ClusterId kClusterId = 0x0037;
...
namespace IasZoneCluster {
constexpr ClusterId kClusterId = 0x0500;
...
namespace SoftwareDiagnosticsCluster {
constexpr ClusterId kClusterId = 0x0034;
...
namespace ThreadNetworkDiagnosticsCluster {
constexpr ClusterId kClusterId = 0x0035;

}
namespace WiFiNetworkDiagnosticsCluster {
constexpr ClusterId kClusterId = 0x0036;
