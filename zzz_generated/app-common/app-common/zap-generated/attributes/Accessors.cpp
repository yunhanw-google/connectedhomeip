...
EmberAfStatus Get(chip::EndpointId endpoint, /* TYPE WARNING: unknown defaults to */ uint8_t ** time)
{
...
EmberAfStatus Get(chip::EndpointId endpoint, /* TYPE WARNING: unknown defaults to */ uint8_t ** lastSetTime)
{
...
EmberAfStatus Get(chip::EndpointId endpoint, /* TYPE WARNING: unknown defaults to */ uint8_t ** validUntilTime)
{
...
EmberAfStatus Get(chip::EndpointId endpoint, /* TYPE WARNING: unknown defaults to */ uint8_t ** setpointChangeSourceTimestamp)
{
